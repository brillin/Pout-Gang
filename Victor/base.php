...
<div id="nav">
  ...
  <div id="middlemiddle"><a style="text-decoration: none;" href="starttest.php">Pout Gang</a></div>
...
<div id="w">
  ...
  <br />
  <!-- Olika varor -->
  <form class="" action="databas/addbasket.inc.php" method="post">
  <select id="select" name="produkt">
    <option name="produkt" value="Red Wine">Röd</option>
    <option name="produkt" value="White Wine">Vit</option>
    <option name="produkt" value="Black Wine">Svart</option>
  </select>
  <input type="number" name="antal" value="1">
  <button value="basketvin" class="button" type="submit" name="basketvin">
    Lägg Till
  </button>
</form>
